...
public class NettyClientHandlerInit extends ChannelInitializer<SocketChannel> {

	private static int WRITE_IDLE_TIMEOUT = 30000;
	...
	protected void initChannel(SocketChannel ch) throws Exception {
		...
		pipeline.addLast("protobufDecoder", new ProtobufDecoder(
				cn.com.papi.NettyClient.protobuf.WebMessagePojo.WebMessage.getDefaultInstance()));
